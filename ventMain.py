...
class Ui_ventMain(object):
    def setupUi(self, ventMain):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/descarga (1).png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/descarga.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/6437583.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
